...
def audit_receipts_v3(output, root, stage):
    def path(name):
        return output / ("goal_v3_isolation_v3_" + name + ".json")
    ...
    return {"schema_version": "guardian-goal-v3-v3-independent-physical-audit-v1", "stage": stage,
...
if __name__ == "__main__":
    ...
    report = audit_receipts_v3(OUT, ROOT, args.stage)
    if args.save:
        write_new(OUT / ("goal_v3_isolation_v3_" + args.stage + "_independent_receipt_audit.json"), report)
